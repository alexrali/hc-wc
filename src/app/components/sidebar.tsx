...
import { Home, LineChart, Package, Package2, ShoppingCart, Settings, Users2 } from "lucide-react";
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            ...
                            >
                                ...
                                <span className="sr-only">Analitica</span>
                            </Link>
                        </TooltipTrigger>
                        <TooltipContent side="right">Analitica</TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            </nav>
